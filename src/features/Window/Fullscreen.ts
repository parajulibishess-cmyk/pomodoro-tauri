...
export function initFullscreenToggle(buttonId: string) {
  ...
  // Instantiate the window reference for Tauri v2
  ...
  btn.className = "p-2 text-[#8e8070] hover:bg-white/50 rounded-xl transition-all active:scale-95 border-2 border-transparent hover:border-white/50 shadow-sm";
